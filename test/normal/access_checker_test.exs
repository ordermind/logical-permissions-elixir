defmodule AccessCheckerTest do
  ...
  test "check_access/3 wrong permission value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: The permission value must be either a list, a map, a string, an atom or a boolean. Evaluated permissions: %{flag: 50}"}
  end
  ...
  test "check_access/3 nested permission types" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: You cannot put a permission type as a descendant to another permission type. Existing type: :flag. Evaluated permissions: %{flag: \"testflag\"}"}
  ...
  test "check_access/3 unregistered type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: The permission type :unregistered has not been registered. Please refer to the documentation regarding how to register a permission type."}
  end

  test "check_access/3 wrong context param type" do
    assert LogicalPermissions.AccessChecker.check_access(false, 0) ==
             {:error, "The context parameter must be a map."}
  end

  test "check_access/3 wrong allow_bypass param type" do
    assert LogicalPermissions.AccessChecker.check_access(false, %{}, "test") ==
             {:error, "The allow_bypass parameter must be a boolean."}
  end

  test "check_access/2 bypass access list allow" do
    assert LogicalPermissions.AccessChecker.check_access([false], %{bypass_access: true}) ==
             {:ok, true}
  end

  test "check_access/2 bypass access list deny" do
    assert LogicalPermissions.AccessChecker.check_access([false], %{bypass_access: false}) ==
             {:ok, false}
  end
  ...
  test "check_access/2 bypass access error list permissions" do
    assert LogicalPermissions.AccessChecker.check_access([role: "admin"], %{error: "Test error"}) ==
             {:error, "Error checking access bypass: Test error"}
  end

  test "check_access/2 bypass access error boolean permission" do
    assert LogicalPermissions.AccessChecker.check_access(false, %{error: "Test error"}) ==
             {:error, "Error checking access bypass: Test error"}
  end
  ...
  test "check_access/1 no_bypass wrong type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions) ==
             {:error,
              "Error checking if bypassing access should be forbidden: The no_bypass value must be either a list, a map or a boolean. Current value: \"test\""}
  end
  ...
  test "check_access/3 no_bypass illegal descendant" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: The :no_bypass key must be placed highest in the permission hierarchy. Evaluated permissions: %{no_bypass: true}"}
  end
  ...
  test "check_access/1 no_bypass wrong return type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions) ==
             {:error,
              "Error checking if bypassing access should be forbidden: An unexpected value was returned from Elixir.LogicalPermissions.Test.InvalidReturnValue.check_permission/2. Please refer to the behaviour to see what kind of values are valid. Received value: {:ok, \"invalid_return_value\"}"}
  end
  ...
  test "check_access/2 no_bypass map allow" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}) ==
             {:ok, true}
  end
  ...
  test "check_access/3 no type error" do
    permissions = ["no_type"]

    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: A permission check is attempted but no type has been supplied. Evaluated permissions: \"no_type\""}
  end
  ...
  test "check_access/3 single permission list error" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error, "Error checking access: misc permission check error"}
  end
  ...
  test "check_access/3 shorthand OR map" do
    permissions = %{
      flag: "testflag",
      role: "admin"
    }
  ...
  test "check_access/3 shorthand OR list multiple types" do
    permissions = [
      flag: "testflag",
      role: "admin",
      flag: "test"
  ...
  test "check_access/3 shorthand OR list multiple values" do
    permissions = [
  ...
  test "check_access/3 AND wrong value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value of an AND gate must be a list or a map. Current value: \"admin\""}
  end

  test "check_access/3 AND map empty value" do
    permissions = [
      role: [
        and: %{}
      ]
  ...
  test "check_access/3 AND list multiple types" do
    permissions = [
      and: [
        flag: "testflag",
        role: "admin",
  ...
  test "check_access/3 AND list multiple values" do
    permissions = [
      role: [
  ...
  test "check_access/3 NAND wrong value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value of a NAND gate must be a list or a map. Current value: \"admin\""}
  end

  test "check_access/3 NAND map empty value" do
    permissions = [
      role: [
        nand: %{}
      ]
  ...
  test "check_access/3 NAND list multiple types" do
    permissions = [
      nand: [
        flag: "testflag",
        role: "admin",
  ...
  test "check_access/3 NAND list multiple values" do
    permissions = [
      role: [
  ...
  test "check_access/3 OR wrong value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value of an OR gate must be a list or a map. Current value: \"admin\""}
  end

  test "check_access/3 OR map empty value" do
    permissions = [
      role: [
        or: %{}
      ]
  ...
  test "check_access/3 OR list multiple types" do
    permissions = [
      or: [
        flag: "testflag",
        role: "admin",
  ...
  test "check_access/3 OR list multiple values" do
    permissions = [
      role: [
  ...
  test "check_access/3 NOR wrong value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value of a NOR gate must be a list or a map. Current value: \"admin\""}
  end

  test "check_access/3 NOR map empty value" do
    permissions = [
      role: [
        nor: %{}
      ]
  ...
  test "check_access/3 NOR list multiple types" do
    permissions = [
      nor: [
        flag: "testflag",
        role: "admin",
  ...
  test "check_access/3 NOR list multiple values" do
    permissions = [
      role: [
  ...
  test "check_access/3 XOR wrong value type" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value of a XOR gate must be a list or a map. Current value: \"admin\""}
  end
  ...
  test "check_access/3 XOR list multiple types" do
    permissions = [
      xor: [
        flag: "testflag",
        role: "admin",
  ...
  test "check_access/3 NOT map too few elements" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value map of a NOT gate must contain exactly one element. Current value: %{}"}
  end
  ...
  test "check_access/3 NOT map too many elements" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value map of a NOT gate must contain exactly one element. Current value: %{0 => \"admin\", 1 => \"writer\"}"}
  end
  ...
  test "check_access/3 NOT list too few elements" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error,
              "Error checking access: The value list of a NOT gate must contain exactly one element. Current value: []"}
  end
  ...
  test "check_access/3 NOT string empty" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{user: user}, false) ==
             {:error, "Error checking access: The value of a NOT gate cannot be an empty string."}
  end
  ...
  test "check_access/3 bool illegal children" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: A boolean permission cannot have children. Evaluated permissions: %{true: false}"}
  end
  ...
  test "check_access/3 bool TRUE illegal descendant" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: You cannot put a boolean permission as a descendant to a permission type. Existing type: :role. Evaluated permissions: true"}
  end
  ...
  test "check_access/3 bool FALSE illegal descendant" do
    ...
    assert LogicalPermissions.AccessChecker.check_access(permissions, %{}, false) ==
             {:error,
              "Error checking access: You cannot put a boolean permission as a descendant to a permission type. Existing type: :role. Evaluated permissions: false"}
  end
